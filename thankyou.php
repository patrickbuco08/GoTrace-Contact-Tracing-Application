...
<div class="d-md-flex h-md-100 align-items-center" style="padding-top:160px; ">
		<div class="text-white d-md-flex align-items-center h-100 p-5 text-center justify-content-center">
				...
				<h1 class="mb-0 mt-3 display-4"> <b>Thanks for caring!</b></h1><br>
				<h5 class="mb-4 font-weight-light" >Your response have been recorded. Let's all help in preventing the spread of COVID-19 in our community. Always remember to wear mask, sanitize, and scan! Take care.
</h5>
				</a>
				</div>
		</div>
	<div class="col-md-6 p-0 h-md-100 loginarea" >
		<div class="text-white d-md-flex align-items-center h-100 p-5 text-center justify-content-center">
					<img src='illust-join.png'  class="img-fluid" alt="Responsive image" >
		</div>
	</div>
</div>
<!-- End Main -->
