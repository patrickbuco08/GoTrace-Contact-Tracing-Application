...
if(!$_SESSION['splash'])
{
    ...
    echo "<div id='Splash'>
        <img src='splash-mobile.png' class='splashimg' />
    </div>";
  }
...
<a href="https://gotrace.cvsuccatre.com" class="logo"><img src="WiTR-rectangle-2.png" style="height:64px" /></a> 
     ...
     <!-- <div class="locator" style="text-align:center; width: 100%;">
           <h6 style="text-align:center; color:#262626; font-size:11px;">
                <span class="fa fa-map"></span> You're in<strong> Cavite State Univeristy </strong> </h6> </div> -->
</nav>
  

 <foot> 
<div style=" position: fixed; left:0;  bottom: 0;  width: 100%; font-size:10px; color:gray; text-align:center; background-color:white;">
<p > Copyright 2020. All rights reserved. <a href="https://reserviceportal.cvsuccatre.com" style="color:gray;">Cavite State University-CCAT Research and Extension Unit.</a> <a href="https://gotrace.cvsuccatre.com/dataprivacy.php" style="color:gray;">Data Privacy. Terms and Conditions.</a></p>    
</div>
</foot>
